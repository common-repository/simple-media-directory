...
$instance_smdf2 = new QcPluginUpgradeToProNotice();
...
{ 
	...
	$instance_smdf2->upgrade_link = "https://www.quantumcloud.com/products/simple-media-directory/";
	//$instance_smdf2->link_color = "#FCB214";
	//$instance_smdf2->link_text = "Upgrade To Pro";
	//$instance_smdf2->link_class = "";
	//$instance_smdf2->link_target = "_blank";

	$instance_smdf2->plugin_slug = 'simple-media-directory'; //Plugin Slug. i.e. Folder Name
	$instance_smdf2->plugin_main_file = 'qc-smd-directory-main.php'; //Primary file of the pluign
	$instance_smdf2->plugin_menu_slug = 'edit.php?post_type=smd'; //Main Menu Slug

	$instance_smdf2->show_with_action_links = true; //show in plugin.php page
	$instance_smdf2->show_with_meta_links = true; //show in plugin.php page
	$instance_smdf2->show_with_plugin_menu = true; //show inside parent menu of the plugin

	if( $instance_smdf2->check_if_plugin_page() )
	{
		//$instance_smdf2->hook_with_plugin_action_links();
		//$instance_smdf2->hook_with_plugin_meta_links();
	}
	
	//$instance_smdf2->hook_with_plugin_submenu();
