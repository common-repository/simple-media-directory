<?php wp_enqueue_style('smd-css-style-3', QCSMD_TPL_URL . "/$template_code/template.css" ); ?>
...
if ( $list_query->have_posts() ) 
{
	...
	while ( $list_query->have_posts() ) 
	{
        ...
        <style>
            ...
            #qcsmd-list-<?php echo $listId .'-'. get_the_ID(); ?>.qcsmd-list-column.style-3 .smd-ca-menu li .smd-ca-main {
            ...
            #qcsmd-list-<?php echo $listId .'-'. get_the_ID(); ?>.qcsmd-list-column.style-3 .smd-ca-menu li .smd-ca-sub {
					...
					<li id="item-<?php echo esc_attr(get_the_ID() ."-". $count); ?>">
						...
						<?php endif; ?>
							...
							<?php if( ($list_img == "true") && isset($list['qcsmd_item_img'])  && $list['qcsmd_item_img'] != "" ) : ?>
								<span class="smd-ca-icon smd-list-img-1 has-img">
									<?php 
							...
							<?php else : ?>
								<span class="smd-ca-icon smd-list-img-1 no-img">
						...
						<?php if( $upvote == 'on' ) : ?>
							...
							<!-- /upvote section -->
						<?php else: ?>
							<div class="smd-upvote-section smd-upvote-off"></div>
						<?php endif; ?>
