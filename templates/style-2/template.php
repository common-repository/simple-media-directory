...
<?php wp_enqueue_style('smd-css-style-2', QCSMD_TPL_URL . "/$template_code/template.css" ); ?>
...
if ( $list_query->have_posts() ) 
{
	...
	while ( $list_query->have_posts() ) 
	{
        ...
        <style>
            ...
            #qcsmd-list-<?php echo $listId .'-'. get_the_ID(); ?>.qcsmd-list-column.style-2 .smd-ca-menu li .smd-ca-main {
            ...
            #qcsmd-list-<?php echo $listId .'-'. get_the_ID(); ?>.qcsmd-list-column.style-2 .smd-ca-menu li .smd-ca-sub {
		...
		<div id="qcsmd-list-<?php echo esc_attr($listId .'-'. get_the_ID()); ?>" class="qc-grid-item qcsmd-list-column smd-column-<?php echo esc_attr($column); echo " " . esc_attr($style);?> <?php echo esc_attr("smd-list-id-" . get_the_ID()); ?>">
						...
						<?php endif; ?>
							...
							<?php if( ($list_img == "true") && isset($list['qcsmd_item_img'])  && $list['qcsmd_item_img'] != "" ) : ?>
								<span class="smd-ca-icon smd-list-img-1">
									<?php 
										$img = wp_get_attachment_image_src($list['qcsmd_item_img']);
									?>
							...
							<div class="smd-ca-content">
                                <h3 class="smd-ca-main <?php echo $canContentClass; ?>">
								<?php 
