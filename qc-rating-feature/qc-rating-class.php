 ...
 *******************************/
if( !class_exists('Qc_smd_rating') ){
	
	class Qc_smd_rating{
		
		public $plugin_name = "smd"; //Without spaces
		public $plugin_full_name = "Simple Media Directory";
		public $logo_url;
		
		public $plugin_rating_url = "https://wordpress.org/support/view/plugin-reviews/simple-media-directory?rate=5#postform";
		
		public function __construct(){
			$this->logo_url = QCSMD_IMG_URL . "/logo.png";
		}
		...
		public function qc_load_rating_style(){
			wp_enqueue_style( 'qc_smd_rating_stylesheet', plugin_dir_url(__FILE__)."css/style.css");
		}
		...
		?>
			<div class="qc-review-notice">
				...
				<div class="qc-review-text">
					...
					<h3><?php esc_html_e( 'Leave A Review for Simple Media Directory?', 'qc-smd' ) ?></h3>
					
					<p><?php esc_html_e( 'We hope you\'ve enjoyed using <b>Simple Media Directory</b>! Would you consider leaving us a review on WordPress.org?', 'qc-smd' ) ?></p>
					
					<ul class="qc-review-ul">
					
						<li><a href="<?php echo esc_url($this->plugin_rating_url); ?>" target="_blank"><span class="dashicons dashicons-star-filled"></span><?php esc_html_e( 'Leave A Review', 'qc-smd' ) ?></a></li>
						 <li><a href="<?php echo esc_url($dismiss_url); ?>"><span class="dashicons dashicons-yes"></span><?php esc_html_e( 'I\'ve already left a review', 'qc-smd' ) ?></a></li>
						 <li><a href="<?php echo esc_url($later_url); ?>"><span class="dashicons dashicons-calendar"></span><?php esc_html_e( 'Maybe Later', 'qc-smd' ) ?></a></li>
						 <li><a href="<?php echo esc_url($dismiss_url); ?>"><span class="dashicons dashicons-no"></span><?php esc_html_e( 'Never show this again', 'qc-smd' ) ?></a></li>
...
$qc_smd_rating = new Qc_smd_rating();

$qc_smd_rating->plugin_name = 'smd';
